    ...
    <>
      <Header/>
        <div className="container">
          ...
          <p>El objetivo de los grupos pequeños es estrechar lazos entre hermanos. orando unos por otros, exhotando con palabras de animo a quien lo necesite y tener un tiempo de enseñanza y reflexió sobre la palabra de Dios.</p>
          <div className="container__grupos-pequeños">
            <div>
              <h3><img src={bullet}/> Grupo pequeño Martes 19:00 hrs.</h3>
              <p>Responsable: <strong>Jesús</strong></p>
            ...
            <div>
              <h3><img src={bullet}/> Grupo pequeño Miercoles 20:00 hrs.</h3>
              <p>Responsable: <strong>Liliana</strong></p>
              <p>Plataforma: <strong>Skipe</strong></p>
